...
- Dashboard và Guests dùng mock data. Guests đã có search theo tên, lọc xác nhận tham dự/nhóm, selection/bulk actions phía client, bảng compact 50 dòng/trang trên desktop và card list trên mobile; contact/email không hiển thị trong primary directory. API, import wizard, detail sheet và server pagination chưa kết nối. RSVP/wishes/editor/templates/analytics/settings vẫn là route placeholder.
