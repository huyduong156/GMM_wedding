...
- Visual style catalog nằm tại `docs/wedding-design-styles/`; 2.5D là lựa chọn theo art direction với mức none/light/medium/high, không phải yêu cầu bắt buộc cho mọi theme. Mỗi viewport chỉ có một depth focal point và mọi composition phải có mobile/reduced-motion fallback tĩnh hoàn chỉnh.
