...
export type RedSpiderLilyPerson = { id: string; name: string; role: string; media: RedSpiderLilyMedia; gallery?: RedSpiderLilyMedia[] }
export type RedSpiderLilyBehindScene = { id: string; title: string; caption: string; media: RedSpiderLilyMedia; gallery?: RedSpiderLilyMedia[] }
...
export const redSpiderLilyRecapContent: RedSpiderLilyRecapContent = {
  ...
  optional: {
    ...
    peopleBehindTheDay: { enabled: true, title: 'Những người phía sau ngày hôm ấy', body: 'Gia đình và bạn bè đã cùng làm nên ngày này.' },
    weddingFilm: { enabled: true, title: 'Thước phim của ngày hôm ấy', body: 'Một đoạn phim ngắn để xem lại những chuyển động thân thương.' },
    soundtrack: { enabled: true, title: 'Âm thanh của ký ức', body: 'Một bản nhạc tùy chọn đồng hành cùng album.' },
    behindTheScenes: { enabled: true, title: 'Phía sau cánh hoa', body: 'Những khoảnh khắc chuẩn bị trước khi buổi lễ bắt đầu.' },
