export type RedSpiderLilyMedia = {
  src: string
  alt: string
  role: 'hero' | 'story' | 'chapter' | 'moment' | 'finale' | 'video-poster'
}
...
export type RedSpiderLilyOptionalContent = { enabled: boolean; title: string; body: string }

export type RedSpiderLilyRecapContent = {
  hero: { couple: string; date: string; place?: string; tagline: string; ctaLabel: string; media?: RedSpiderLilyMedia }
...
export const redSpiderLilyRecapContent: RedSpiderLilyRecapContent = {
  hero: { couple: 'Minh & Anh', date: '20.08.2026', place: 'Hà Nội', tagline: 'Những ngày đã qua, những điều còn ở lại', ctaLabel: 'Mở album' },
  ourStory: {
    eyebrow: 'Lời dẫn',
  ...
  chapters: [
    { id: 'engagement', dateLabel: '01.01.2026', title: 'Lễ đính hôn', description: 'Một ngày nhỏ đánh dấu một hành trình lớn.', cover: { src: '', alt: 'Ảnh đại diện lễ đính hôn', role: 'chapter' } },
    { id: 'bride-arrival', dateLabel: '20.08.2026', title: 'Ngày rước dâu', description: 'Khoảnh khắc hai gia đình chính thức trở thành một.', cover: { src: '', alt: 'Ảnh đại diện ngày rước dâu', role: 'chapter' } },
    { id: 'the-wedding', dateLabel: '20.08.2026', title: 'Ngày chúng mình cưới', description: 'Một buổi chiều đỏ son, rất nhiều nụ cười và một lời hứa ở lại.', cover: { src: '', alt: 'Ảnh đại diện ngày cưới', role: 'chapter' } },
  ],
  moments: [
    { id: 'photobooth', title: 'Photobooth', description: 'Những nụ cười và những kiểu tạo dáng không thể diễn lại lần hai.', cover: { src: '', alt: 'Ảnh bìa photobooth', role: 'moment' } },
  ...
  optional: {
    guestbook: { enabled: false, title: 'Lời chúc ở lại', body: 'Những lời chúc đã được gửi đến hai chúng mình.' },
    peopleBehindTheDay: { enabled: false, title: 'Những người phía sau ngày hôm ấy', body: 'Gia đình và bạn bè đã cùng làm nên ngày này.' },
    weddingFilm: { enabled: false, title: 'Thước phim của ngày hôm ấy', body: 'Một đoạn phim ngắn để xem lại những chuyển động thân thương.' },
    soundtrack: { enabled: false, title: 'Âm thanh của ký ức', body: 'Một bản nhạc tùy chọn đồng hành cùng album.' },
    behindTheScenes: { enabled: false, title: 'Phía sau cánh hoa', body: 'Những khoảnh khắc chuẩn bị trước khi buổi lễ bắt đầu.' },
    memoryCapsule: { enabled: false, title: 'Chương tiếp theo', body: 'Một lời nhắn ngắn gửi đến những ngày sắp tới.' },
  },
}
