...
export const editorialVowsTemplateConfig = {
  ...
  description: 'Editorial cinematic màu xanh cobalt với love-story chapters.',
  capabilities: { commonRsvp: true, guestbook: true, backgroundMusic: true, seo: true },
  theme: {
    palettes: ['porcelain-cobalt'],
    heroStyles: ['full-bleed-editorial'],
    storyStyles: ['sticky-chapters'],
    galleryStyles: ['editorial-grid'],
    default: {
      palette: 'porcelain-cobalt',
