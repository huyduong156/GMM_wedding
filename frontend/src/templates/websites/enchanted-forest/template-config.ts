...
export const enchantedForestTemplateConfig = {
  templateKey: 'enchanted-forest',
  displayName: 'Enchanted Forest Wedding',
  ...
  status: 'ready',
  type: 'website',
  previewPath: '/templates/websites/enchanted-forest/preview',
  description: 'Website cưới 2.5D rừng cổ thụ, rêu và ánh nắng xuyên tán.',
  capabilities: { commonRsvp: true, guestbook: true, backgroundMusic: false, seo: true },
  theme: {
    palettes: ['enchanted-moss'],
    heroStyles: ['layered-memory'],
    storyStyles: ['sticky-chapters'],
    galleryStyles: ['editorial-grid'],
    default: {
      palette: 'enchanted-moss',
      heroStyle: 'layered-memory',
      storyStyle: 'sticky-chapters',
