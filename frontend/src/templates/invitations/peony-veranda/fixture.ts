import type { PeonyVerandaData } from './PeonyVerandaInvitation'
...
export const peonyVerandaFixture: PeonyVerandaData = {
  ...
  ceremonyNote: 'Trang phục thanh lịch, sắc màu nhẹ nhàng.',
  receptionTime: '19:00',
  brideFatherName: 'Nguyễn Văn Lâm',
  brideMotherName: 'Trần Thu Hương',
  groomFatherName: 'Phạm Văn Thành',
  groomMotherName: 'Lê Ngọc Mai',
  brideFamilyAddress: '18 Phan Đình Phùng, Hà Nội',
  groomFamilyAddress: '86 Trần Duy Hưng, Hà Nội',
  receptionGreeting: 'Kính mời bạn đến dự tiệc và nâng ly chúc mừng cùng gia đình chúng mình.',
