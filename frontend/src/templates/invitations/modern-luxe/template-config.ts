...
export const modernLuxeDisplayStyles = {
  gallery: [
    { key: 'deck-3d', label: 'Slide 3D' },
    { key: 'editorial-grid', label: 'Lưới editorial' },
    { key: 'film-row', label: 'Dải ảnh ngang' },
  ],
  activities: [
    { key: 'activity-cards', label: 'Thẻ nổi' },
    { key: 'activity-grid', label: 'Lưới ảnh' },
    { key: 'activity-marquee', label: 'Dải chuyển động' },
  ],
} as const
...
export const modernLuxeTemplateConfig = {
  ...
  sections: [
    ...
    },
    {
      ...
      fields: {
        milestones: {
          ...
          label: 'Các cột mốc',
          contentKey: 'loveJourney',
          maxItems: 8,
          itemFields: {
            year: { type: 'string', label: 'Năm', required: true, maxLength: 12 },
            title: { type: 'string', label: 'Tên cột mốc', required: true, maxLength: 80 },
            note: { type: 'text', label: 'Mô tả', maxLength: 180 },
            image: { type: 'image', label: 'Ảnh cột mốc', mediaRole: 'journey' },
          },
        },
        autoPlay: { type: 'boolean', label: 'Tự động chạy' },
      },
    },
    {
      sectionKey: 'families',
    ...
    },
    {
      ...
      fields: {
        ...
        dateMedia: {
          ...
          label: 'Ảnh thời gian hôn lễ',
          mediaRole: 'event-details',
        },
      },
    },
    {
      sectionKey: 'countdown',
      label: 'Lịch cưới và đếm ngược',
      canToggle: true,
      canReorder: true,
      fields: {},
    },
    ...
    },
    {
      ...
      canReorder: true,
      fields: {
        venueName: { type: 'string', label: 'Tên địa điểm', required: true },
        venueAddress: { type: 'string', label: 'Địa chỉ', required: true },
        mapUrl: { type: 'url', label: 'Đường dẫn bản đồ' },
        calendarUrl: { type: 'url', label: 'Đường dẫn thêm lịch' },
      },
    },
    {
      ...
      fields: {
        displayStyle: {
          type: 'select',
          contentKey: 'activitiesStyle',
          label: 'Kiểu hiển thị',
          options: modernLuxeDisplayStyles.activities,
        },
        items: {
          type: 'items',
          recommendedMinItems: 3,
    ...
    },
    {
      ...
      fields: {
        displayStyle: {
          type: 'select',
          contentKey: 'galleryStyle',
          label: 'Kiểu hiển thị',
          options: modernLuxeDisplayStyles.gallery,
        },
        images: {
          type: 'images',
