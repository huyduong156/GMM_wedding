export const modernLuxeTemplateConfig = {
  ...
  sections: [
    ...
    { sectionKey: 'families', label: 'Thông tin hai gia đình', required: true, canToggle: false, canReorder: true, fields: { brideFather: { type: 'string', maxLength: 80 }, brideMother: { type: 'string', maxLength: 80 }, groomFather: { type: 'string', maxLength: 80 }, groomMother: { type: 'string', maxLength: 80 } } },
