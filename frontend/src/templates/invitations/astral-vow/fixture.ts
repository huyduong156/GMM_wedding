...
export const astralVowFixture: AstralVowData = {
  ...
  venue: { title: 'Đài quan sát của chúng mình', name: 'Stellarium Event Hall', address: '88 Võ Văn Tần, Quận 3, TP. Hồ Chí Minh', mapUrl: 'https://maps.google.com', message: 'Hẹn bạn tại nơi ánh đèn và những vì sao cùng lấp lánh.' },
  gallery: { title: 'Chòm sao ký ức', message: 'Những mảnh sáng nhỏ trên hành trình của chúng mình.' }, galleryImages: [],
  ...
  music: { backgroundMusicUrl: '', backgroundMusicName: '', backgroundMusicAutoplay: false }, footer: { title: 'Hẹn gặp bạn dưới cùng một bầu trời', message: 'Cảm ơn bạn đã mở lá thư và trở thành một phần của đêm đặc biệt này.' }, footerMedia: null,
}
export const astralVowSectionConfig: AstralVowSectionConfig = { enabled: ['opening', 'cover', 'invitation', 'families', 'eventDetails', 'countdown', 'timeline', 'venue', 'gallery', 'rsvp', 'guestbook', 'gift', 'music', 'footer'], order: ['opening', 'cover', 'invitation', 'families', 'eventDetails', 'countdown', 'timeline', 'venue', 'gallery', 'rsvp', 'guestbook', 'gift', 'music', 'footer'] }
