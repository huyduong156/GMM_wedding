export const verdantPromiseTemplateConfig = {
  templateKey: 'verdant-promise', displayName: 'Verdant Promise', templateVersion: '1.0.0', templateConfigVersion: '1.0', contentSchemaVersion: '1.0', rendererApiVersion: '1.0', status: 'development', type: 'invitation',
  ...
  sections: [
    ...
    { sectionKey: 'families', label: 'Thông tin hai gia đình', canToggle: true, canReorder: true },
