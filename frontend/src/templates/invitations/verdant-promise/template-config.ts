export const verdantPromiseTemplateConfig = {
  templateKey: 'verdant-promise', displayName: 'Verdant Promise', templateVersion: '1.3.0', templateConfigVersion: '1.0', contentSchemaVersion: '1.0', rendererApiVersion: '1.0', status: 'ready', type: 'invitation',
