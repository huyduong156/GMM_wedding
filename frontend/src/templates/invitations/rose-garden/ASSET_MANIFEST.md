...
| `rg-garden-envelope-vignette-v1.png` | Floating keepsake envelope; `families`; active | A keepsake letter carrying the family announcement; blush paper, burgundy roses and sage leaves | 1312×1199 PNG, RGBA, near 1.09:1; keep main envelope inside central 84%, edge foliage may crop | Floats behind the family cards at the right edge; shifts farther outward on narrow mobile and never covers parent names | `P-PROP-1`: isolated couture garden envelope vignette, blush handmade paper and pressed rose foliage, transparent background. Same generation provenance | Reads as envelope at small size; no text/person; clean alpha; family hierarchy remains clear |
| `rg-botanical-cluster-v1.png` | Corner cluster; `invitation` and bride family card; active | A collected rose-garden specimen anchoring the letter and the bride household; burgundy/dusty rose petals and sage leaves | 1230×1278 PNG, RGBA, near square; main bloom inside central 84%, outer leaves may softly crop | Corner accent scaled down on mobile; family use stays clipped inside its card and never covers names | `P-BOT-1`: isolated asymmetrical botanical corner cluster, dusty rose and burgundy watercolor flowers, sage foliage. Same generation provenance | Recognizable silhouette; no hard rectangular edge; does not compete with invitation copy |
...
| `rg-botanical-cluster.png` | Groom family card cluster; `families`; active | Fuller alternate garden specimen distinguishing the groom household in the shared rose/sage watercolor material | 1312×1199 PNG, RGBA, near 1.09:1; main mass inside central 84% | Mirrored and clipped into the lower corner of the groom card; larger on stacked mobile cards without covering names | `P-BOT-2`: isolated full botanical rose cluster, dusty rose, burgundy and sage, transparent background. Same generation provenance | Distinct from `v1`; clean alpha; remains decorative and subordinate to family names |
| `rg-botanical-sprig.png` | Botanical sprig; `invitation`, `countdown` and `guestbook`; active | A light single branch for low-density seams; sage stem with dusty-rose accents | 1145×1374 PNG, RGBA, portrait; full stem inside central 84% | Used as bounded corner accents; countdown mirrors a restrained pair behind its plaque; reduce density on mobile | `P-BOT-3`: isolated delicate vertical botanical sprig, sage and dusty rose watercolor, transparent background. Same generation provenance | Thin details survive small scale; no hard edge; must not become repeated wallpaper |
...
| `rg-center-floral-cluster.png` | Ceremonial canopy focal; `families`; active | A horizontal floral arrangement marking the union of two families; layered rose and sage watercolor | 1536×1024 PNG, RGBA, 3:2; main blooms inside central 84% | Centered above the family heading; scales to content width without covering copy on mobile | `P-BOT-5`: centered horizontal floral cluster, layered dusty rose blooms and sage leaves, transparent background. Same generation provenance | Balanced center weight; transparent edge; no text/person |
