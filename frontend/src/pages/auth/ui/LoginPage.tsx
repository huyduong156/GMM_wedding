...
function loginError(error: unknown) {
  ...
  if (error.code === 'REQUEST_ORIGIN_REJECTED')
    return 'Yêu cầu đăng nhập bị từ chối. Hãy kiểm tra cấu hình địa chỉ frontend.'
    ...
    <main className="login-page">
      <section className="login-story" aria-label="Giới thiệu GMM Wedding">
        ...
        <p className="login-trust">
          <ShieldCheck size={18} /> Dữ liệu của bạn được bảo vệ và không chia sẻ với bên thứ ba.
        </p>
      </section>
      ...
      <section className="login-panel" aria-labelledby="login-title">
        ...
        <form className="login-card" onSubmit={submit}>
          ...
          <div className="login-password-row">
            ...
            <AppLink to={marketingRoutes.forgotPassword}>Quên mật khẩu?</AppLink>
          </div>
