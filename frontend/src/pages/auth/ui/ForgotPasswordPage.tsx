  ...
  return (
    <AuthRecoveryLayout titleId="forgot-password-title">
      <form className="login-card auth-recovery-card" onSubmit={submit}>
        ...
        <p>
          Nhập email đã đăng ký. Nếu tài khoản hợp lệ, chúng tôi sẽ gửi hướng dẫn đặt lại mật khẩu.
        </p>
        {sent ? (
          <div className="auth-form-success" role="status">
            ...
            <div>
              ...
              <span>Nếu email tồn tại và đủ điều kiện, liên kết đặt lại mật khẩu đã được gửi.</span>
            </div>
          </div>
        ) : (
          <>
