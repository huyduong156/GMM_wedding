...
} from '../../../templates/websites/green-hydrangea/content'
...
export function PublicWebsitePage({ weddingSlug }: { weddingSlug: string }) {
  ...
  if (!snapshot)
    return (
      <PageLoading
        label="Đang chuẩn bị website cưới"
        detail="Một chút nữa thôi, website đang được mở ra."
      />
    )
...
function WebsiteSnapshot({ snapshot }: { snapshot: Snapshot }) {
  ...
  switch (payload.template.key) {
    case 'editorial-vows':
      return (
        <EditorialVowsWebsite
          data={content as EditorialVowsData}
          sectionConfig={sectionConfig as EditorialVowsSectionConfig | undefined}
        />
      )
    case 'green-hydrangea':
      return (
        <GreenHydrangeaWebsite
          data={content as GreenHydrangeaData}
          sectionConfig={sectionConfig as GreenHydrangeaSectionConfig | undefined}
        />
      )
    case 'enchanted-forest':
      return (
        <EnchantedForestWebsite
          data={content as EnchantedForestData}
          sectionConfig={sectionConfig as EnchantedForestSectionConfig | undefined}
        />
      )
    case 'cherry-blossom-garden':
      return (
        <CherryBlossomGardenWebsite
          data={content as CherryBlossomData}
          sectionConfig={sectionConfig as CherrySectionConfig | undefined}
        />
      )
    default:
      return (
