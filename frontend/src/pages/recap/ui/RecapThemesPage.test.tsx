...
describe('RecapThemesPage', () => {
  ...
  it('loads the recap catalog and creates a draft when starting from a theme', async () => {
    ...
    vi.spyOn(weddingApi, 'templates').mockResolvedValue({
      items: [
        {
          key: 'red-spider-lily-recap',
          name: 'Dấu Son Bỉ Ngạn',
          productType: 'RECAP',
          status: 'ACTIVE',
          description: 'Recap botanical editorial',
          versions: [
            {
    ...
    vi.spyOn(weddingApi, 'recap').mockRejectedValue(
      new WeddingApiError(404, 'RECAP_NOT_FOUND', 'not found'),
    )
    const save = vi.spyOn(weddingApi, 'saveRecap').mockResolvedValue({
      recap: {
        id: '33333333-3333-4333-8333-333333333333',
        weddingId: wedding.id,
        status: 'DRAFT',
        slug: null,
        title: 'Wedding Recap của Mai & Đức',
        ...
        content: {},
        themeConfig: {},
        sectionConfig: { enabled: sections, order: sections },
        revision: 1,
        publishedAt: null,
        updatedAt: '2026-08-10T00:00:00Z',
        templateVersion: {
