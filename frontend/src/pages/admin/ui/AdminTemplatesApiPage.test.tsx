...
describe('AdminTemplatesApiPage', () => {
  ...
  it('syncs directly without opening a bundle modal', async () => {
    ...
    const sync = vi.spyOn(adminTemplateApi, 'sync').mockResolvedValue({ created: 1, unchanged: 0, results: [] })
    render(<NavigationProvider><AdminTemplatesApiPage kind="invitation" /></NavigationProvider>)
