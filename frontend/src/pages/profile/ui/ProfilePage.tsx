...
export function ProfilePage() {
  ...
  const avatarInitials = useMemo(
    () => initials(displayName || (user?.displayName ?? null), user?.email ?? ''),
  ...
  return (
    <div className="wedding-page profile-page">
      ...
      <form className="profile-layout" onSubmit={save}>
        <section className="settings-panel profile-identity-panel">
          <header>
            ...
            <div>
              <h2>Hồ sơ của bạn</h2>
              <p>Thông tin này chỉ dành cho tài khoản đang đăng nhập.</p>
            </div>
          </header>
          <div className="profile-identity-content">
            <div className="profile-avatar-wrap">
              {avatarUrl ? (
                <img className="profile-avatar" src={avatarUrl} alt="Ảnh đại diện" />
              ) : (
            ...
            <div className="profile-fields">
              ...
              <label>
                Email <span className="field-readonly-note">Không thể đổi tại đây</span>
                <input value={user.email} readOnly aria-describedby="profile-email-help" />
              </label>
              <small id="profile-email-help" className="profile-help">
                Email dùng để đăng nhập và nhận thông báo tài khoản.
              </small>
            </div>
          </div>
        </section>
        <section className="settings-panel">
          <header>
            <Phone size={20} />
            <div>
              <h2>Liên hệ & hiển thị</h2>
              <p>Bạn có thể để trống số điện thoại hoặc ảnh đại diện.</p>
            </div>
          </header>
        ...
        <section className="settings-panel">
          <header>
            ...
            <div>
              ...
              <p>Được dùng cho định dạng ngày giờ và thông báo.</p>
            </div>
          </header>
          <div className="settings-fields profile-fields-grid">
            <SelectField
        ...
        {feedback ? (
          <p className={`workspace-save-message profile-feedback ${feedback.tone}`} role="status">
        ...
        <div className="settings-save">
          <button className="button button-primary" type="submit" disabled={saving}>
            {saving ? (
              ...
              <>
                <FloppyDisk size={17} /> Lưu thông tin
              </>
            )}
          </button>
        </div>
