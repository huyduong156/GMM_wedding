...
const activity = [
  { initials: 'HN', name: 'Hà Nguyễn', action: 'đã xác nhận tham dự', time: '8 phút trước', tone: 'rose' },
  { initials: 'TL', name: 'Tuấn Lê', action: 'đã gửi một lời chúc', time: '24 phút trước', tone: 'violet' },
  { initials: 'MA', name: 'Minh Anh', action: 'tham dự cùng 2 người', time: '1 giờ trước', tone: 'blue' },
  { initials: 'PT', name: 'Phương Trần', action: 'đã cập nhật phản hồi', time: '3 giờ trước', tone: 'amber' },
]

const trend = [28, 34, 31, 42, 48, 45, 58, 64, 61, 72, 76, 86]
...
export function DashboardPage() {
  return (
    <div className="dashboard-page">
      ...
      <section className="status-strip" aria-label="Trạng thái thiệp cưới">
        <div className="status-strip-main">
          <span className="status-icon"><PaperPlaneTilt size={19} /></span>
          <div><strong>Thiệp đang được xuất bản</strong><p>gmmwedding.vn/mai-va-duc</p></div>
        </div>
