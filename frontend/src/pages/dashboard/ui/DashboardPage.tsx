      ...
      <section className="overview-header">
        <div className="overview-header-topline">
          <p className="breadcrumb">
            Mai & Đức <span>/</span> Tổng quan
          </p>
          <span className="overview-date">
            <CalendarBlank size={15} /> 30 tháng 09, 2026
          </span>
        </div>
        <div className="page-heading">
          ...
          <div className="page-actions">
            <button className="button button-secondary">
              <Eye size={17} /> Xem thiệp
            </button>
            <button className="button button-primary">
              <ShareNetwork size={17} /> Chia sẻ thiệp
            </button>
          </div>
        </div>
        ...
        <div className="dashboard-primary">
          <section className="panel trend-panel">
            <header className="panel-header">
              <div>
                <h2>Phản hồi theo thời gian</h2>
                <p>30 ngày gần nhất</p>
              </div>
              <button className="select-button">
                <CalendarBlank size={16} /> 30 ngày <span>⌄</span>
              </button>
            </header>
            <div className="chart-summary">
              <strong>86 phản hồi</strong>
              <span>+18% so với tháng trước</span>
            </div>
            <div
              className="trend-chart"
              role="img"
              aria-label="Biểu đồ phản hồi tăng từ 28 lên 86 trong 30 ngày"
            >
          ...
          <section className="panel guest-status-panel">
            <header className="panel-header">
              <div>
                <h2>Tình trạng khách mời</h2>
                <p>Tổng cộng 128 lời mời</p>
              </div>
              <AppLink className="inline-link" to={studioRoutes.guests}>
                Quản lý <ArrowRight size={15} />
              </AppLink>
            </header>
            <div className="attendance-layout">
              <div className="donut" aria-label="67 phần trăm khách đã phản hồi">
                <div>
                  <strong>67%</strong>
        ...
        <aside className="dashboard-rail" aria-label="Sự kiện và hoạt động">
          <section className="panel next-event-panel">
            ...
            <div className="event-copy">
              ...
              <h2>Lễ thành hôn</h2>
              <p>
                <Clock size={15} /> 17:30, Thứ Bảy
              </p>
              <p>
                <LinkSimple size={15} /> White Palace, TP. Hồ Chí Minh
              </p>
            </div>
            <AppLink className="button button-secondary compact" to={studioRoutes.settings}>
          ...
          <section className="panel activity-panel">
            <header className="panel-header">
              ...
              <AppLink className="inline-link" to={studioRoutes.rsvps}>
      ...
      <section className="quick-links" aria-label="Thao tác nhanh">
        <AppLink to={studioRoutes.guests}>
          ...
          <div>
            ...
            <small>Tạo lời mời và link riêng</small>
          </div>
          <ArrowRight size={17} />
        </AppLink>
        <AppLink to={studioRoutes.invites}>
          <span>
            <Heart size={19} />
          </span>
          <div>
            <strong>Chỉnh sửa nội dung</strong>
            <small>Cập nhật câu chuyện và hình ảnh</small>
          </div>
          <ArrowRight size={17} />
        </AppLink>
        <AppLink to={studioRoutes.inviteThemes}>
          ...
          <div>
            <strong>Đổi giao diện</strong>
            <small>Khám phá các mẫu thiệp mới</small>
          </div>
          <ArrowRight size={17} />
        </AppLink>
      </section>
