...
export interface CreateGuestData { displayName: string; categoryId?: string | null | undefined; groupId?: string | null | undefined; phone?: string | null | undefined; email?: string | null | undefined; note?: string | null | undefined; tableName?: string | null | undefined; maxPartySize: number; tags: string[] }
...
export interface GuestImportRow { displayName: string; categoryPath?: string | undefined; groupName?: string | undefined; phone?: string | null | undefined; email?: string | null | undefined; note?: string | null | undefined; tableName?: string | null | undefined; maxPartySize?: number | undefined; tags?: string[] | undefined }
...
export interface UpdateInvitationData { label?: string | null | undefined; maxPartySize?: number | undefined; expiresAt?: Date | null | undefined }
export interface GuestRepository {
  listOwned(userId: string, weddingId: string, filter: { query?: string | undefined; categoryId?: string | null | undefined; groupId?: string | null | undefined; limit: number; cursor?: string | undefined }): Promise<{ items: GuestView[]; nextCursor: string | null } | null>
  ...
  bulkDeleteCategories(userId: string, weddingId: string, categoryIds: string[]): Promise<{ deletedCount: number } | null>
  ...
  updateGroup(userId: string, weddingId: string, groupId: string, data: UpdateGroupData): Promise<GuestGroupView | null>
  deleteGroup(userId: string, weddingId: string, groupId: string): Promise<boolean | null>
  listInvitations(userId: string, weddingId: string, filter: { guestId?: string | undefined; status?: 'ACTIVE' | 'REVOKED' | undefined; limit: number; cursor?: string | undefined }): Promise<{ items: InvitationView[]; nextCursor: string | null } | null>
  findInvitation(userId: string, weddingId: string, invitationId: string): Promise<InvitationView | null>
  ...
  updateInvitation(userId: string, weddingId: string, invitationId: string, data: UpdateInvitationData): Promise<InvitationView | null>
