...
function repository(overrides: Partial<GuestRepository> = {}): GuestRepository { return { listOwned: vi.fn().mockResolvedValue({ items: [guest], nextCursor: null }), findOwned: vi.fn().mockResolvedValue(guest), createOwned: vi.fn().mockResolvedValue(guest), updateOwned: vi.fn().mockResolvedValue(guest), deleteOwned: vi.fn().mockResolvedValue(true), bulkDeleteOwned: vi.fn().mockResolvedValue({ deletedCount: 1 }), listCategories: vi.fn().mockResolvedValue([]), createCategory: vi.fn().mockResolvedValue({}), updateCategory: vi.fn().mockResolvedValue({}), deleteCategory: vi.fn().mockResolvedValue(true), bulkDeleteCategories: vi.fn().mockResolvedValue({ deletedCount: 1 }), listGroups: vi.fn().mockResolvedValue([]), createGroup: vi.fn().mockResolvedValue({}), updateGroup: vi.fn().mockResolvedValue({}), deleteGroup: vi.fn().mockResolvedValue(true), listInvitations: vi.fn().mockResolvedValue({ items: [], nextCursor: null }), findInvitation: vi.fn().mockResolvedValue({}), createInvitation: vi.fn().mockResolvedValue({ invitation: {}, token: 'token' }), updateInvitation: vi.fn().mockResolvedValue({}), rotateInvitation: vi.fn().mockResolvedValue({ invitation: {}, token: 'token' }), revokeInvitation: vi.fn().mockResolvedValue(true), resolvePublicInvitation: vi.fn().mockResolvedValue(null), exportOwned: vi.fn().mockResolvedValue([]), importOwned: vi.fn().mockResolvedValue([]), ...overrides } }
