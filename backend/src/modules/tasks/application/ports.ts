...
export interface TaskListFilter {
  ...
  withoutEvent?: boolean | undefined
  parentTaskId?: string | undefined
  withoutParent?: boolean | undefined
  from?: Date | undefined
  to?: Date | undefined
  limit: number
...
export interface TaskRepository {
  ...
  ): Promise<{ items: TaskView[]; nextCursor: string | null } | null>
  ...
  updateOwned(
    ...
    taskId: string,
    data: UpdateTaskData,
  ): Promise<TaskView | 'conflict' | null>
...
export interface TaskChecklistTemplateView {
  id: string
  key: string
  version: number
  name: string
...
export interface BulkCreateTasksData {
  tasks: Array<Omit<CreateTaskData, 'parentTaskId'>>
}
