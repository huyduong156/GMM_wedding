...
export const taskQuerySchema = z
  .object({
    ...
    withoutEvent: z.coerce.boolean().optional(),
    parentTaskId: uuid.optional(),
    withoutParent: z.coerce.boolean().optional(),
...
export const updateTaskSchema = z
  .object({
    ...
    eventId: z.union([uuid, z.null()]).optional(),
    parentTaskId: z.union([uuid, z.null()]).optional(),
    dueAt: z.union([dateTime, z.null()]).optional(),
    priority: priority.optional(),
    status: status.optional(),
