...
export async function PUT(request: NextRequest, context: Context) {
  ...
  try {
    ...
    return withApiHeaders(jsonResponse(await getPublicInteractionService().submitPersonalRsvp(weddingSlug, guestSlug, await parseJson(request, rsvpSchema))), requestId)
